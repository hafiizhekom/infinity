...
<div class="text-center title">
    ...
    <div class="text-muted" style="padding-top: 10px;">Diposting oleh <?php echo $this->admin_model->profile($jurnal->result()[0]->author)->result()[0]->nama." pada tanggal ";
