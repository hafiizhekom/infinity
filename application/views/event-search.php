...
<div id="searchevent" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <form action="<?php echo base_url('event/search'); ?>" method="POST">
...
<?php if(strtolower($this->uri->segment(1))=="event" && $this->uri->segment(2)==""){ ?>
<script>
  $(document).ready(function () {
  $('html, body').animate({
...
<?php }else if(strtolower($this->uri->segment(1))=="event" && strtolower($this->uri->segment(2))=="limit"){ ?>
<script>
  $(document).ready(function () {
  $('html, body').animate({
