	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				Admin Panel <small>Absen </small>
				</h1>
				<ol class="breadcrumb">
					<li class="active"> Event
					</li>
					<li class="active"> <?php echo $this->acara_model->acara($crew->result()[0]->id_acara)->result()[0]->nama_acara; ?>
					</li>
				...
				<div class="row">
					<div class="container-fluid">
						<form action="<?php echo current_url(); ?>" method="POST">
							...
							<input class="btn btn-primary pull-right" value="Save" name="simpan_absen_acara" type="submit">
						</form>
					</div>
				</div>
			</div>
