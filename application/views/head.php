...
<head>
  ...
  <?php
    ...
    if(isset($page)){
      echo "<link rel='stylesheet' type='text/css' href='".base_url()."css/gallery.css'>";
    }else{
      echo "<link rel='stylesheet' type='text/css' href='".base_url()."css/news.css'>";
    }
        ...
        <div class="row">
          <div class="jumbotron text-center">
            <div class="container-fluid">
              ...
              <div class="col-md-6">
                <img src="<?php echo base_url(); ?>image/logo/logo.png" width="30%">
                <h1>INFINITY</h1>
