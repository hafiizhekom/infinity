  ...
  <div class="container">
    ...
    <!--<div class="search-wrapper">
      <div class="container">
        ...
        foreach ($searchdata->result() as $key => $value) {
          $top_image="";
      		...
      		echo "<div class='col-lg-3 col-md-4 col-sm-6 col-xs-12' id='newssquare'>
                  <div class='hovereffect'>";
      					...
      					if($top_image!=""){
      						...
      						echo "<img class='img-responsive' src='".base_url()."/image/default.jpg' alt='' style='object-fit: cover; width:100%;height:200px;'>";
      					}
          ...
          echo "<div class='text-center'>Tidak ditemukan</div>";
        }?>
        ...
        <?php
          ...
          if(strtolower($this->uri->segment(1))=="news" && $this->uri->segment(2)==""){
            if($this->news_model->articles()->num_rows()>4){
              echo "<a href='".base_url('news/limit/12')."' class='btn btn-primary' id='readmorebtn'>Readmore</a>";
            }else{
            }
          }else if(strtolower($this->uri->segment(1))=="news" && strtolower($this->uri->segment(2))=="limit"){

            $lmt=$this->uri->segment(3);
            if($lmt<$this->news_model->articles()->num_rows()){
            $lmt=$lmt+4;
            echo "<a href='".base_url('news/limit/'.$lmt)."' class='btn btn-primary' id='readmorebtn'>Readmore</a>";
            }else{
            }
          }
...
<ul class="sharegroup">
    <li ><a href="#" class=" btn-circle btn-primary" style="vertical-align: center;" data-toggle="modal" data-target="#searchnews"><div class='fa fa-facebook' style="font-size:20px;"></div></a></li>
</ul>
<div id="searchnews" class="modal fade" role="dialog">
  <div class="modal-dialog">

    <!-- Modal content-->
    <div class="modal-content">
    <form action="<?php echo base_url('news/search'); ?>" method="GET">
...
<?php if(strtolower($this->uri->segment(1))=="news" && $this->uri->segment(2)==""){ ?>
<script>
  $(document).ready(function () {
  $('html, body').animate({
...
<?php }else if(strtolower($this->uri->segment(1))=="news" && strtolower($this->uri->segment(2))=="limit"){ ?>
<script>
  $(document).ready(function () {
  $('html, body').animate({
        scrollTop: $(".readmoregroup").offset().top -70
    }, 800);
});
</script>
<?php } ?>
